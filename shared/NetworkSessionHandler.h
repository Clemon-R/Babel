...
public:
    ...
    virtual void onReceived(ptr<NetworkSession> session, const char *data, sizet size) const = 0;
    virtual void onSent(ptr<NetworkSession> session, const char *data, sizet size) const = 0;
